...
import { Plantas } from 'src/app/registros/plantas.model';
import { RegistrosService } from 'src/app/registros/registros.service';


@Component({
  selector: 'app-edit-seguimiento',
  templateUrl: './edit-seguimiento.page.html',
  styleUrls: ['./edit-seguimiento.page.scss'],
})
export class EditSeguimientoPage implements OnInit {
